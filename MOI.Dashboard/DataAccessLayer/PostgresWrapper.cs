...
namespace MOI.Patrol.DataAccessLayer
{
    public class PostgresWrapper : IDbLayer
    {
        ...
        public PostgresWrapper(IConfiguration configuration)
        {
            _connectionstring = configuration;
            constr = _connectionstring["ConnectionStrings:DefaultConnection"];
            _npgsqlConnection = new NpgsqlConnection(constr);
        }

        private readonly MOI_ApplicationPermissionContext _dbContext = new MOI_ApplicationPermissionContext();


        /// <summary>
        /// The _NPGSQL connection
        /// </summary>
        private readonly NpgsqlConnection _npgsqlConnection = new NpgsqlConnection(constr);
        ...
        private NpgsqlCommand CreateCommandWithParameters(string procName, IEnumerable<KeyValuePair<string, object>> parameters)
        {
            ...
            if (!commandText.Contains("."))
                commandText = PatrolPGSQLConstants.SCHEMA + "." + procName;
        ...
        public PostgresWrapper(MOI_ApplicationPermissionContext dbContext)
        {
        ...
        public PostgresWrapper(string PostgresConnectionString) //SecurityContext
        {
            ...
            {
                _dbContext = new MOI_ApplicationPermissionContext();
