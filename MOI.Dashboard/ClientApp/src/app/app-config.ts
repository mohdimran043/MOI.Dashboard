export class DattaConfig {
  public static config = {
    ...
    'collapse-menu': true,
    'layout-type': null, // menu-dark, menu-light, dark
    'nav-icon-color': true,
    ...
    'nav-back-image': 'navbar-image-2', // false, navbar-image-1, navbar-image-2, navbar-image-3, navbar-image-4, navbar-image-5
    'rtl-layout': true,
    ...
    'nav-list-title-color': 'title-lightblue', // title-default, title-blue, title-red, title-purple, title-lightblue, title-dark
